object ServerMethods2: TServerMethods2
  ...
  object ArchiveTable: TFDQuery
    ...
    SQL.Strings = (
      'select '
      '"Orders"."ID","Orders"."AddressFrom",'
      '"Orders"."AddressTo","Orders"."OrderDate",'
      '"Orders"."Additional",'
      '"Driver"."Login" '
      'from "Orders" '
  ...
  object ActiveOrderTable: TFDQuery
    ...
    SQL.Strings = (
      ...
      '"Orders"."ID","Orders"."AddressFrom",'
      '"Orders"."AddressTo","Orders"."OrderDate",'
      '"Orders"."Additional","Order_status"."Status",'
      '"Driver"."Login" '
      'from "Orders" '
      ...
      'left join "Driver" on'
      '"Orders"."ID_Driver" = "Driver"."ID"'
      'left join "Driver_status" on'
      '"Driver_status"."ID" = "Driver"."Driver_Status"'
      ''
      '')
    Left = 112
    Top = 160
  ...
  object FreeDriver: TFDQuery
    DetailFields = 'Car;Car_Sign;First_Name;ID;Login;Phone;Second_Name;Third_Name'
    Connection = PGTaxiConnection
    SQL.Strings = (
      'select "ID","Login","First_Name","Second_Name",'
      '"Third_Name","Car","Car_Sign","Phone" from "Driver" '
  ...
  object FreeDriverDSP: TDataSetProvider
    DataSet = FreeDriver
    Left = 184
    Top = 8
  end
